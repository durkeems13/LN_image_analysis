...
export predict_dir=../../../data/HighRes_FFPE_pDC_trainset/$pred_ims
#export predict_dir=/nfs/kitbag/CellularImageAnalysis/Lupus/High_Dim_LuN/cell_segmentation/MP_cell_analysis/B-T_testset/val/$pred_ims
...
#export PYTHONPATH="./.local/lin/python3.7/site-packages:$PYTHONPATH"
SECONDS=0
