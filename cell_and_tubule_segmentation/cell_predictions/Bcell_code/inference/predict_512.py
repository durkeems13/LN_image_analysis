...
sys.path.append('../../../experiments/MRCNN_Bcell_training')
...
class ResNetC4Model(DetectionModel):
    def inputs(self):
        ret = [
            tf.placeholder(tf.float32, (None, None, 2), 'image'), #changed 6 to 3
    ...
    if args.visualize or args.evaluate or args.predict:
        ...
        if args.visualize:
            ...
            if args.evaluate:
                ...
                COCODetection('../../../data/Bcell_finetune','val')   # Only to load the class names into caches
