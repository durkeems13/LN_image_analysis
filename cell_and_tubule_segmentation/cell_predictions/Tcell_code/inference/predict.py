...
sys.path.append('../../../experiments/CDM_ResNet_validation_FFPE_ss_Tcells')
    ...
    if args.visualize or args.evaluate or args.predict:
        ...
        if args.visualize:
            ...
            if args.evaluate:
                ...
                COCODetection('../../../data/Human_FFPE_Tcells_trainset_fold1','val')   # Only to load the class names into caches
