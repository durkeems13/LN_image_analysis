...
import sys
sys.path.append('../../../experiments/Tcell_segmentation')
import eval
...
def eliminate_by_precedence(thedict,imx,imy):
    ...
    for i in range(len(thedict)):
        ...
        classes.append(thedict[i][2])
        scores.append(thedict[i][1])
