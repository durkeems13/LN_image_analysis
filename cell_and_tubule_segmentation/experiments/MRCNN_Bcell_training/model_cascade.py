...
class CascadeRCNNHead(object):
    def __init__(self, proposals,
        ...
        if self.is_training:
            ...
            self.gt_probs = proposals.gt_probs
        else:
    ...
    def match_box_with_gt(self, boxes, iou_threshold):
        ...
        if self.is_training:
            with tf.name_scope('match_box_with_gt_{}'.format(iou_threshold)):
                ...
                probs_per_box = tf.gather(self.gt_probs, best_iou_ind)
                ...
                return BoxProposals(
                    boxes, labels_per_box, fg_inds_wrt_gt, self.gt_boxes,self.gt_labels, self.gt_probs, probs_per_box)
        else:
