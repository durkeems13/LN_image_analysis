...
_C.TRAIN.BASE_LR = 1e-4  # 1e-2 defined for a total batch size of 8. Otherwise it will be adjusted automatically
...
_C.TRAIN.LR_SCHEDULE = [10000,12500,15000] # [120000,160000,180000]    # "2x" schedule in detectron
